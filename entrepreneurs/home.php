...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item">
                        <a class="nav-link active" style="color:#3b486f;font-weight:700" aria-current="page" href="/entrepreneurs/home.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " style="color:#3b486f;" aria-current="page" href="/entrepreneurs/activities.php">Activities</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " style="color:#3b486f;" aria-current="page" href="/entrepreneurs/store.php">Store</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " style="color:#3b486f;" aria-current="page" href="/entrepreneurs/chat.php">Chat</a>
                    </li>
    ...
    <main class="container mt-3 mb-3">
        <p style="background-color:rgba(159,163,179,1);padding:10px;border-radius:8px;color:#444;border:1px solid #ccc;font-size:18px">Welcome <span style="font-size:20px;color:white"><?php echo($_SESSION["enname"])?></span> ,</p>
