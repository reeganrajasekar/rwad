...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form onsubmit="document.getElementById('loader').style.display='block'" enctype="multipart/form-data" action="/admin/action/event.php" method="post">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="/admin/action/delete_event.php" method="get">
