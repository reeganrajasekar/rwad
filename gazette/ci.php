...
<body>
                ...
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="/gazette/ci.php">RWAD Community Initiative</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="img_hold gaz_bg">
        <h2>RWAD Community Initiative</h2>
    </div>
    <main >
        <section class="container py-4">
            <div class="row">
            <?php
            $sql = "SELECT * FROM gaz WHERE type='RWAD Community Initiative' order by date DESC LIMIT 6";
