        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="color:#3b486f;font-weight:700" aria-current="page" href="/entrepreneurs/activities.php">Activities</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container mt-3 mb-3">
        ...
        <div class="row">
            ...
            if ($result->num_rows > 0) {
                ?>
                <h3 class="mb-3" style="color:#3b486f">Recent Activities :</h3>
                <?php
