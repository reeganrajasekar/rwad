...
<body>
                ...
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="/gazette/xworldcup.php">RWAD X World Cup</a></li>
    ...
    <div class="img_hold gaz_bg">
        <h2>RWAD X World Cup</h2>
    </div>
    <main >
        <section class="container py-4">
        <div class="row">
            <?php
            $sql = "SELECT * FROM gaz WHERE type='RWAD X World Cup' order by date DESC LIMIT 6";
