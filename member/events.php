...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h4 class="modal-title" style="color:#012970">Add Event</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <!-- Modal body -->
        <div class="modal-body">
            <form onsubmit="document.getElementById('loader').style.display='block'" enctype="multipart/form-data" action="/member/action/event.php" method="post">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="/member/action/delete_event.php" method="get">
