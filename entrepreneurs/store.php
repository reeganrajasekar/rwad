        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="color:#3b486f;font-weight:700" aria-current="page" href="/entrepreneurs/store.php">Store</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container mt-3 mb-3">
        ...
        <div class="row">
            ...
            if ($result->num_rows > 0) {
                ?>
                <h3 class="mb-3" style="color:#3b486f">Merch Store :</h3>
                <?php
                ...
                <article class="col-sm-12 col-md-6 col-lg-4 mb-1" >
                    <div title="" class="card w-100" data-aos="fade-in" data-aos-once="true" >
                        ...
                        <div class="card-body text-center">
                            <a style="text-decoration:none;color:#444;" href="" target="_blank">
                                <span class="sjcet-text" style="font-size:16px !important">
                                    <?php echo($row["title"]) ?> - <?php echo($row["rate"]) ?>
                                </span>
                            </a>
                            <br>
