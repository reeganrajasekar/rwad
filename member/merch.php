...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form onsubmit="document.getElementById('loader').style.display='block'" enctype="multipart/form-data" action="/member/action/merch.php" method="post">
                ...
                <div class="form-floating mb-3 mt-3">
                    <input required type="number" class="form-control"  name="rate" placeholder="PIN">
                    <label>Rate</label>
                </div>
...
<div class="table-responsive">        
    <table class="table table-striped table-bordered" style="background-color:white">
        ...
        <tbody>
        <?php
            $result = $conn->query("SELECT * FROM store ORDER BY id DESC");
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="/member/action/delete_merch.php" method="get">
