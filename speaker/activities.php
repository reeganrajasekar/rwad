        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item">
                        <a class="nav-link " style="color:#3b486f;" aria-current="page" href="/speaker/home.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" style="color:#3b486f;font-weight:700" aria-current="page" href="/speaker/activities.php">Activities</a>
                    </li>
                    <li class="nav-item">
