...
<head>
  ...
  <title>Rwad - Entrepreneurs</title>
...
<body style="background-image:url('/static/img/home_bg.jpg');background-position:center center;background-repeat:no-repeat;background-size:cover">
            ...
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-2 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Rwad - Entrepreneurs / Speakers</h5>
                  </div>

                  <form class="row g-3 needs-validation" action="/entrepreneurs/signup.php" method="post">
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">User Type</label>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="comname" class="form-control" id="yourUsername" required>
                  ...
                  <br>
                  <p class="text-center">Do have an Account? <a href="/entrepreneurs/">Signin</a></p>
                </div>
              </div>
